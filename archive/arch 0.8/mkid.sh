#!/usr/bin/env bash
#
# create unique id for board
#
# Copyright (C) 2014 Uvea I. S., Kevin Rattai
#
# use date and mac address as identifier (board must have NIC)
# nb mac should be enough for identifier, but date added
# as insurance for unique rather than random number for ability
# to age check
