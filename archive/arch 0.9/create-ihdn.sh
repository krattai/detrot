...
#
# Useage:
# wget -N -r -nd -l2 -w 3 -P $HOME --limit-rate=50k http://192.168.200.6/files/create-ihdn.sh; chmod 777 $HOME/create-ihdn.sh; $HOME/./create-ihdn.sh; rm $HOME/create-ihdn.sh
