...
#
# Although we've solved the problem of cutting into the game, now we have other issues.
# 1.  It's playing the same commercial over and over again, anywhere from 4 to 6 times before seeing the next commercial.
# 2.  Many times...like 75% of the times it plays maybe 10 seconds of the commercial and the reverts back to the Network commercial
